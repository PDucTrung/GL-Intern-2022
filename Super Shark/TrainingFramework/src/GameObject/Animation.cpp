...
Animation::Animation() : m_numFrames(0) ,m_currentFrames(0), m_frameTime(0.0f), m_currentFrameTime(0.0f)
{}
Animation::Animation(std::shared_ptr<Model> model, std::shared_ptr<Shader> shader, std::shared_ptr<Texture> texture, int numFrames, float frameTime)
